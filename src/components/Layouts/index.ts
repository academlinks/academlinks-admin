...
export { default as DetailedCurrentWorkplace } from "./DetailedItems/DetailedCurrentWorkplace";
...
export { default as UserDetailsHeader } from "./UserDetailsHeader/UserDetailsHeader";
